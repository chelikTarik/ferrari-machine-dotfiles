...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd([[cliphist list | wofi --dmenu --pre-display-cmd "echo '%s' | cut -f 2" | cliphist decode | wl-copy]]))
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd(lock))
hl.bind(mainMod .. " + Q", workspaces) -- see scripts/workspaces.lua
...
hl.bind("CTRL + SPACE",  hl.dsp.exec_cmd("playerctl play-pause"))
